...
export default component$(() => {
  return (
    <>
      {/* Hero Section */}
      <section class="relative flex h-[85vh] w-full flex-col items-center justify-center overflow-hidden bg-muted">
        {/* Placeholder for background video/image */}
        <div class="absolute inset-0 z-0 bg-secondary/80 mix-blend-multiply"></div>
        <div class="absolute inset-0 z-0 opacity-50 bg-[url('https://placehold.co/1920x1080/webp')] bg-cover bg-center"></div>
        ...
        <div class="container relative z-10 mx-auto px-4 text-center md:px-8">
          <h1 class="mb-6 font-heading text-4xl font-extrabold tracking-tight text-white sm:text-5xl md:text-6xl lg:text-7xl">
            ...
            <span class="text-accent">Calidad para tu Confección</span>
          </h1>
          <p class="mx-auto mb-8 max-w-2xl text-lg text-slate-200 sm:text-xl">
          ...
          <div class="flex flex-col items-center justify-center gap-4 sm:flex-row">
            <Link
              href="/catalogo/"
              class="inline-flex h-12 items-center justify-center rounded-sm bg-primary px-8 font-medium text-primary-foreground transition-colors hover:bg-primary/90 focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2"
            >
              Ver Catálogo de Telas
            </Link>
            <Link
              href="/mayoristas/"
              class="inline-flex h-12 items-center justify-center rounded-sm border border-white/50 bg-transparent px-8 font-medium text-white transition-colors hover:bg-white/10 focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2"
            >
              Comprar por Mayor
            </Link>
          </div>
      ...
      {/* Ventajas Section */}
      <section class="container mx-auto py-20 px-4 md:px-8">
        <div class="mb-12 text-center">
          <h2 class="font-heading text-3xl font-bold tracking-tight text-foreground sm:text-4xl">¿Por qué elegir Textil CCE?</h2>
          <p class="mt-4 text-muted-foreground">Somos tu proveedor de telas para ropa confiable en Buenos Aires.</p>
        </div>
          ...
          {[
            {
              ...
              icon: <svg class="h-10 w-10 text-primary" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>,
            },
            {
              title: "Ventas Mayoristas",
              desc: "Condiciones ideales y precios competitivos para marcas, talleres y emprendedores.",
              icon: <svg class="h-10 w-10 text-primary" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4" /></svg>,
            },
            {
              title: "Amplio Surtido",
              desc: "Gran variedad de telas para indumentaria con reposición constante.",
              icon: <svg class="h-10 w-10 text-primary" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 7v10c0 2.21 3.582 4 8 4s8-1.79 8-4V7M4 7c0 2.21 3.582 4 8 4s8-1.79 8-4M4 7c0-2.21 3.582-4 8-4s8 1.79 8 4m0 5c0 2.21-3.582 4-8 4s-8-1.79-8-4" /></svg>,
            },
            {
              title: "Colores de Temporada",
              desc: "Paletas actualizadas y texturas que marcan tendencia en cada colección.",
              icon: <svg class="h-10 w-10 text-primary" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 21a4 4 0 01-4-4V5a2 2 0 012-2h4a2 2 0 012 2v12a4 4 0 01-4 4zm0 0h12a2 2 0 002-2v-4a2 2 0 00-2-2h-2.343M11 7.343l1.657-1.657a2 2 0 012.828 0l2.829 2.829a2 2 0 010 2.828l-8.486 8.485M7 17h.01" /></svg>,
            },
            {
            ...
            },
            {
              ...
              icon: <svg class="h-10 w-10 text-primary" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7h12m0 0l-4-4m4 4l-4 4m0 6H4m0 0l4 4m-4-4l4-4" /></svg>,
            },
          ].map((item, index) => (
            <div key={index} class="flex flex-col items-center rounded-lg border border-border bg-card p-6 text-center text-card-foreground shadow-sm transition-shadow hover:shadow-md">
              <div class="mb-4 rounded-full bg-primary/10 p-3">
                {item.icon}
              </div>
              <h3 class="mb-2 font-heading text-xl font-semibold">{item.title}</h3>
      ...
      <section class="bg-muted/50 py-20">
        <div class="container mx-auto px-4 md:px-8">
          <div class="mb-12 flex flex-col items-center justify-between gap-4 sm:flex-row">
            <div>
              <h2 class="font-heading text-3xl font-bold tracking-tight text-foreground sm:text-4xl">Categorías Destacadas</h2>
              <p class="mt-2 text-muted-foreground">Descubrí las telas más buscadas por nuestros clientes.</p>
            </div>
            <Link href="/catalogo/" class="inline-flex items-center text-sm font-medium text-primary hover:underline">
          ...
          <div class="grid grid-cols-1 gap-6 sm:grid-cols-3">
            {[
              ...
              <Link key={index} href={cat.href} class="group relative block h-80 overflow-hidden rounded-lg bg-secondary">
                <img
                  src={cat.img}
                  alt={cat.title}
                  width="600"
      ...
      {/* Final CTA */}
      <section class="container mx-auto py-20 px-4 md:px-8">
        <div class="relative overflow-hidden rounded-2xl bg-secondary px-6 py-16 text-center text-secondary-foreground shadow-2xl sm:px-16 sm:py-20">
          ...
          <div class="relative z-10 mx-auto max-w-2xl">
            ...
            <div class="mt-10 flex justify-center">
              <a
                ...
                class="inline-flex h-14 items-center justify-center rounded-sm bg-accent px-8 font-medium text-accent-foreground transition-all hover:bg-accent/90 hover:-translate-y-1 hover:shadow-lg focus:outline-none focus:ring-2 focus:ring-accent focus:ring-offset-2 focus:ring-offset-secondary"
              >
