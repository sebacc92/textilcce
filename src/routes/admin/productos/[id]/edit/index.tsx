  ...
  async (data, requestEvent) => {
    try {
      ...
      const coloresArray = data.colores
        ? data.colores.split(',').map((c: string) => c.trim()).filter(Boolean)
        : [];
        ...
        >
          <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
            ...
            <div class="sm:col-span-2">
              ...
              <textarea id="colores" name="colores" rows={2} placeholder="Ej: Blanco, Negro, Azul Marino" class="mt-1 block w-full rounded-md border-slate-300 shadow-sm focus:border-slate-500 focus:ring-slate-500 sm:text-sm border px-3 py-2">{product.value.colores?.join(', ') || ''}</textarea>
            ...
            <div class="sm:col-span-2 py-4 border-t border-slate-100 mt-2">
              <label class="relative inline-flex items-center cursor-pointer group">
                <input type="checkbox" name="isOffer" class="sr-only peer" checked={product.value.isOffer || false} />
            ...
            <div class="sm:col-span-2 space-y-3 mt-2 border-t pt-4 border-slate-200">
              ...
              <div class="flex gap-6">
                <label class="relative inline-flex items-center cursor-pointer">
                  <input type="checkbox" name="sublimar" class="sr-only peer" checked={product.value.sublimar || false} />
                  <div class="w-9 h-5 bg-slate-200 peer-focus:outline-none rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-slate-300 after:border after:rounded-full after:h-4 after:w-4 after:transition-all peer-checked:bg-indigo-600"></div>
                  <span class="ml-2 text-sm font-medium text-slate-700">Sublimar</span>
                </label>
                <label class="relative inline-flex items-center cursor-pointer">
                  <input type="checkbox" name="estampar" class="sr-only peer" checked={product.value.estampar || false} />
                  <div class="w-9 h-5 bg-slate-200 peer-focus:outline-none rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-slate-300 after:border after:rounded-full after:h-4 after:w-4 after:transition-all peer-checked:bg-indigo-600"></div>
                  <span class="ml-2 text-sm font-medium text-slate-700">Estampar</span>
                </label>
                <label class="relative inline-flex items-center cursor-pointer">
                  <input type="checkbox" name="bordar" class="sr-only peer" checked={product.value.bordar || false} />
                  <div class="w-9 h-5 bg-slate-200 peer-focus:outline-none rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-slate-300 after:border after:rounded-full after:h-4 after:w-4 after:transition-all peer-checked:bg-indigo-600"></div>
            ...
            <div class="sm:col-span-2 grid grid-cols-1 gap-6 sm:grid-cols-2 mt-2">
              <div>
                ...
                <input type="text" id="fabricante" name="fabricante" value={product.value.fabricante || ''} class="mt-1 block w-full rounded-md border-slate-300 shadow-sm focus:border-slate-500 focus:ring-slate-500 sm:text-sm border px-3 py-2" />
              </div>
              <div>
                <label for="composicion" class="block text-sm font-medium text-slate-700">Composición</label>
                <input type="text" id="composicion" name="composicion" value={product.value.composicion || ''} class="mt-1 block w-full rounded-md border-slate-300 shadow-sm focus:border-slate-500 focus:ring-slate-500 sm:text-sm border px-3 py-2" />
              </div>
              <div>
                <label for="ancho" class="block text-sm font-medium text-slate-700">Ancho</label>
                <input type="text" id="ancho" name="ancho" value={product.value.ancho || ''} class="mt-1 block w-full rounded-md border-slate-300 shadow-sm focus:border-slate-500 focus:ring-slate-500 sm:text-sm border px-3 py-2" />
              </div>
              <div>
                <label for="oz" class="block text-sm font-medium text-slate-700">OZ</label>
                <input type="text" id="oz" name="oz" value={product.value.oz || ''} class="mt-1 block w-full rounded-md border-slate-300 shadow-sm focus:border-slate-500 focus:ring-slate-500 sm:text-sm border px-3 py-2" />
              </div>
              <div>
                <label for="rinde" class="block text-sm font-medium text-slate-700">Rinde</label>
                <input type="text" id="rinde" name="rinde" value={product.value.rinde || ''} class="mt-1 block w-full rounded-md border-slate-300 shadow-sm focus:border-slate-500 focus:ring-slate-500 sm:text-sm border px-3 py-2" />
              </div>
              <div>
                <label for="complemento" class="block text-sm font-medium text-slate-700">Complemento (ej: Puño)</label>
                <input type="text" id="complemento" name="complemento" value={product.value.complemento || ''} class="mt-1 block w-full rounded-md border-slate-300 shadow-sm focus:border-slate-500 focus:ring-slate-500 sm:text-sm border px-3 py-2" />
              </div>
            </div>
