...
export const products = sqliteTable('products', {
  ...
  sublimar: integer('sublimar', { mode: 'boolean' }).default(false),
  estampar: integer('estampar', { mode: 'boolean' }).default(false),
  bordar: integer('bordar', { mode: 'boolean' }).default(false),
